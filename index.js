...
fake1 = '©[𝙍𝘼𝙀𝙃𝘼𝙉𝟭𝟵𝟴𝟲]-[𝙓𝙃𝙄𝙍𝙊 𝙈𝙃𝙊𝙉𝙎𝙃𝙄𝙉𝙀] ✌️'
...
fake = '𝙍𝘼𝙀𝙃𝘼𝙉 𝟭𝟵𝟴𝟲' // Fake Text Reply / Name Bot ( HW MODS WA )
...
const mess = {
   ...
   "api": "```⊷️「 𝙀𝙍𝙍𝙊𝙍 𝘼𝙔𝘼𝙉𝙆 」```"
    ...
    "only": {
    "group": "```⊷️「 𝙂𝙍𝙊𝙐𝙋 𝙊𝙉𝙇𝙔 𝘼𝙔𝘼𝙉𝙆 」```",
    "pribadi": "```⊷️「 𝙋𝙍𝙄𝙑𝘼𝙏𝙀 𝙊𝙉𝙇𝙔 𝘼𝙔𝘼𝙉𝙆 」```"
   },
   "ban": "```⊷️「 𝙔𝙊𝙐 𝘼𝙍𝙀 𝘽𝘼𝙉𝙉𝙀𝘿 」```"
}
//=================================================//        
		const isUrl = (url) => {
...
//=================================================// 
        const bct = (teks) => {
            Haikal.sendMessage(from, teks, text, {quoted:kal, contextInfo:{"externalAdReply":{"title": fake,"body": `𝙍𝘼𝙀𝙃𝘼𝙉𝟭𝟵𝟴𝟲 𝙓𝙃𝙄𝙍𝙊 𝙈𝙃𝙊𝙉𝙎𝙃𝙄𝙉𝙀`,"previewType": "PHOTO","thumbnailUrl": `https://cdn.pixabay.com/photo/2021/10/14/15/42/15-42-34-820_640.jpg`,"thumbnail": Mthumb,"sourceUrl": `https://youtube.com/channel/UCnQANmWo4iOyC6q6psb5eVg`}}})
        }
//=================================================//        
...
if (kal.key.fromMe) return
freply('𝐍𝐣𝐢𝐞𝐫𝐫 𝐉𝐚𝐧𝐠𝐚𝐧 𝐏𝐚𝐤𝐞 𝐅𝐚𝐤𝐞 𝐓𝐫𝐨𝐥𝐢 _-\n\n' + require('util').format(m.key))
...
"sections": [
{
    "title": "Subscribe XIN 7",
    "rows": [
                 {
          "title": "SEMANGAT YA SAYANG MUACCH",
          "rowId": "SEMANGAT YA SAYANG MUACCH"
          },
       {
          "title": "CIEE AYANK MEMBACA",
          "rowId": "CIEE AYANK MEMBACA"
       },
       {
          "title": "BACA APA AYANK",
          "rowId": "BACA APA AYANK"
          },
          {
          "title": "YANG LANCAR YA MEMBACA NYA AYAK",
          "rowId": "YANG LANCAR YA MEMBACA NYA AYANK"
          },
          {
          "title": "RAEHAN GANTENG",
          "rowId": "RAEHAN GANTENG"
          },
          {
          "title": "SAYANG RAEHAN",
          "rowId": "SAYANG RAEHAN"
          ...
          {
          "title": "FOLLOW INSTAGRAM RAEHAN1986",
          "rowId": "FOLLOW INSTAGRAM RAEHAN1986"
          },
          {
          "title": "MENDING TURU YAKAN BESTIE",
          "rowId": "MENDING TURU YAKAN BESTIE"
          },
          {
          "title": "LEMES BESTIE",
          "rowId": "LEMES BESTIE"
          ...
          {
          "title": "AKU SAYANG BANGET SAMA KAMU",
          "rowId": "AKU SAYANG BANGET SAMA KAMU"
          },
          {
          "title": "SUBSCRIBE XIN 7",
          "rowId": "SUBSCRIBE XIN 7"
          },
          {
          "title": "SAVE RAEHAN",
          "rowId": "SAVE RAEHAN"
          ...
          {
          "title": "SAVE AYANK YAH",
          "rowId": "SAVE YA AYANK"
          },
          {
          "title": "NANTI PASTI KO MENGERTI",
          "rowId": "NANTI PASTI KO MENGERTI"
          },
          {
          "title": "SETELAH SA HILANG DAN SA JAUH UNTUK PERGI",
          "rowId": "SETELAH SA HILANG DAN SA JAUH UNTUK PERGI"
       },
          {
          "title": "owner",
          "rowId": "owner"
...
▬▭▬▭▬▭▬▭▬▬▭▬▭
HELLO !!!
- 𝑰𝑵𝑭𝑶 𝑮𝑹𝑶𝑼𝑷 𝑾𝑯𝑨𝑻𝑺𝑨𝑷𝑷 𝑩𝑶𝑻 -
1. https://chat.whatsapp.com/I6vly7Euyyl1DstBXE7x61
2. https://chat.whatsapp.com/GpGsxblvKXj6RIephuhLs2
3. https://chat.whatsapp.com/JfWkKdJ5PG1LusdkEkuKw0
4. https://chat.whatsapp.com/D0F1pFKUpAj7ZFeYljUjbS
5. https://chat.whatsapp.com/FR32c4pDa81EIFMSi1SATK

- 𝑰𝑵𝑭𝑶 𝑮𝑹𝑶𝑼𝑷 𝑨𝑳𝑳 𝑽𝑰𝑹𝑼𝑺 -
...
case 'demote':
if (isBan) return reply(mess.ban)
if (!isOwner && !kal.key.fromMe && !isGroupAdmins) return freply('𝑨𝒅𝒎𝒊𝒏 𝑮𝒓𝒐𝒖𝒑 𝑶𝒏𝒍𝒚')
if (!isGroup) return
if (!isBotGroupAdmins) return freply('𝑩𝒐𝒕 𝑵𝒐𝒕 𝑨𝒅𝒎𝒊𝒏')
...
freply('``` 𝐒𝐮𝐜𝐜𝐞𝐬 𝐑𝐞𝐯𝐨𝐤𝐞 𝐋𝐢𝐧𝐤 𝐆𝐫𝐨𝐮𝐩```')
break
...
if (isBan) return reply(mess.ban)
if (!isGroup) return freply(mess.only.group)
if (!isGroupAdmins && !kal.key.fromMe && !isOwner) return freply('𝑨𝒅𝒎𝒊𝒏 𝑮𝒓𝒐𝒖𝒑 𝑶𝒏𝒍𝒚')
if (!isBotGroupAdmins) return freply('𝑩𝒐𝒕 𝑵𝒐𝒕 𝑨𝒅𝒎𝒊𝒏')
...
if (!isBotGroupAdmins) return freply('Bot not admin')
if (args.length < 1) return freply('𝗞𝗘𝗧𝗜𝗞 𝟭 𝗨𝗡𝗧𝗨𝗞 𝗠𝗘𝗡𝗚𝗔𝗞𝗧𝗜𝗙𝗞𝗔𝗡\n𝗞𝗘𝗧𝗜𝗞 𝟬 𝗨𝗡𝗧𝗨𝗞 𝗠𝗘𝗡𝗢𝗡𝗔𝗞𝗧𝗜𝗙𝗞𝗔𝗡')
if (args[0] === "1") {
						if (isNsfw) return reply('𝗦𝘂𝗱𝗮𝗵 𝗔𝗸𝘁𝗶𝗳 𝗔𝘆𝗮𝗻𝗸𝗸')
						nsfww.push(from)
						fs.writeFileSync('./database/nsfww.json', JSON.stringify(nsfww))
						reply('𝗦𝘂𝗸𝘀𝗲𝘀 𝗠𝗲𝗻𝗴𝗮𝗸𝘁𝗶𝗳𝗸𝗮𝗻 𝗙𝗶𝘁𝘂𝗿 𝗡𝗦𝗙𝗪 𝗔𝘆𝗮𝗻𝗸𝗸')
						Haikal.sendMessage(from, `Bebas Nyari Hentai :v`, text)
					} else if (Number(args[0]) === 0) {
						if (!isNsfw) return reply('𝗦𝘂𝗱𝗮𝗵 𝗠𝗮𝘁𝗶 𝗬𝗮𝗻𝗸')
						var ini = nsfww.indexOf(from)
						nsfww.splice(ini, 1)
						fs.writeFileSync('./database/nsfww.json', JSON.stringify(nsfww))
						reply('Sukses menonaktifkan fitur nsfw')
					} else {
						reply('𝟭 𝘂𝗻𝘁𝘂𝗸 𝗺𝗲𝗻𝗴𝗮𝗸𝘁𝗶𝗳𝗸𝗮𝗻, 𝟬 𝘂𝗻𝘁𝘂𝗸 𝗺𝗲𝗺𝗮𝘁𝗶𝗸𝗮𝗻')
					}
					break
// Colong Nomor Yok
case 'nowa':
...
case 'tts':
				   ...
				   const gtts = require('./lib/gtts')(args[0])
					...
					rano = getRandom('.ogg')
					bby.length > 300
						? freply('𝗧𝗲𝗸𝘀 𝗡𝘆𝗮 𝗧𝗲𝗿𝗹𝗮𝗹𝘂 𝗣𝗮𝗻𝗷𝗮𝗻𝗴 𝗬𝗮𝗻𝗸𝗸')
...
freply(' 𝗦𝘂𝗰𝗰𝗲𝘀 𝗺𝗲𝗻𝘆𝗮𝗹𝗮𝗸𝗮𝗻 𝗮𝗻𝘁𝗶𝗹𝗶𝗻𝗸 𝗱𝗶 𝗴𝗿𝗼𝘂𝗽 𝗶𝗻𝗶')
...
case 'waraehan':
offline = false
bct(' Https://wa.me/6285349736408?text=Jangan+disalah+gunakan+dapat+menyebabkan+nomor+anda+di+ban')
break
case 'wairham':
offline = false
bct(' Https://wa.me/+6285246444331?text=Jangan+disalah+gunakan+dapat+menyebabkan+nomor+anda+di+ban')
break
case 'watamasya':
case 'wahamza':
offline = false
bct(' Https://wa.me/+6282320290738?text=Jangan+disalah+gunakan+dapat+menyebabkan+nomor+anda+di+ban')
break
case 'waraehan1':
offline = false
bct(' Https://wa.me/+6282195767994?text=Jangan+disalah+gunakan+dapat+menyebabkan+nomor+anda+di+ban')
break
case 'tiktok':
offline = false
bct(' https://vt.tiktok.com/ZSdkWPsfg/')
break
...
*•> Base :* [ 𝙓𝙈 ] - 𝙍𝘼𝙀𝙃𝘼𝙉 - 𝟏𝟗𝟖𝟔✓
*•> Recode :* https://instagram.com/raehan1986  [ 𝙓𝙈 ] - 𝙍𝘼𝙀𝙃𝘼𝙉 - 𝟏𝟗𝟖𝟔✓
*•> Lib :* Baileys, ${bailver}
*•> Prefix :* ${prefi}
*•> Versi Bot :* ${botver}
