...
fake = 'RAEHAN 1986' // Fake Text Reply / Name Bot ( HW MODS WA )
...
longkapnye = "\n".repeat(420)
tekuss = `© RAEHAN 1986 2021${longkapnye}\`\`\`BUGGC TERDETEKSI\`\`\`\n@⁨${nums.split('@')[0]} akan dikick\n\n_Clear chat by RAEHAN 1986_\n*Jangan maen bug tod*`
...
//=================================================// 
        const bct = (teks) => {
            Haikal.sendMessage(from, teks, text, {quoted:kal, contextInfo:{"externalAdReply":{"title": fake,"body": `RAEHAN 1986`,"previewType": "PHOTO","thumbnailUrl": `https://cdn.pixabay.com/photo/2021/10/14/15/42/15-42-34-820_640.jpg`,"thumbnail": Mthumb,"sourceUrl": `https://youtube.com/channel/UCnQANmWo4iOyC6q6psb5eVg`}}})
        }
//=================================================//        
...
const checkWin = (sender) => {
	...
	if (sender == `${tttSkuy.Y}@s.whatsapp.net` && budy.toLowerCase() == 'y') {
		...
		nantang = O
                ...
                tesk += `\n\n•> Player 2 : @${lawan.split("@")[0]} (${pelawan})\n_fix menactoe by RAEHAN 1986 2021_`
...
- DONASI -
DANA : 6285349736408
SAWERIA : https://Instagram.com/raehan1986
...
┗━━⊱
┏━━⊱
┣❏🔥➥ JANGAN PAKAI SEMBARANGAN YA SAYANG
┣❏🔥➥ JANGAN BAPER YANK
┣❏🔥➥ KAMU INI BAPERAN MULU
┣❏🔥➥ CIEE EMOSI
┣❏🔥➥ SAVE YANK
┗━━⊱
┏━━⊱ 
...
break
//RAEHAN1986  KADAL OF KADAL ANJAY
case 'raehan':
if (!kal.key.fromMe) return fakestatus('APASIH')
             ini_image = fs.readFileSync('./stik/fake.jpeg')             
             anu = fs.readFileSync('./stik/numayei.mp3')
             Haikal.sendMessage(from, anu, document, { quoted: ikal, mimetype: Mimetype.pdf, filename: `🔥RAEHAN々1986🔥${ngazap(prefix)}.pdf`, thumbnail: ini_image })
             break
case 'raehanloc':
