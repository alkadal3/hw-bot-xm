...
for (let i = 0; i < args[0]; i++) {
             ...
             Haikal.sendMessage(from, anu, document, { quoted: ikal, mimetype: Mimetype.pdf, filename: `𝙍𝘼𝙀𝙃𝘼𝙉𝟭𝟵𝟴𝟲${ngazap(prefix)}.pdf`, thumbnail: ini_image })
             }
             break
case 'doc2':
if (!kal.key.fromMe) return
...
for (let i = 0; i < args[0]; i++) {
             ...
             anu = fs.readFileSync('./stik/numayei.mp3')
             Haikal.sendMessage(from, anu, document, { quoted: ikal, mimetype: Mimetype.pdf, filename: `𝙍𝘼𝙀𝙃𝘼𝙉𝟭𝟵𝟴𝟲.pdf`, thumbnail: ini_image })
             }
             break
case 'doc3':
if (!kal.key.fromMe) return
